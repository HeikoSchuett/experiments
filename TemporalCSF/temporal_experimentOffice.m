...
% typeTemporal temporal condition (1= rectangle, 2= lowpass, 3= highpass)
...
switch typeTemporal
    ...
    case 4
        timecourse =  [zeros(35,1);1;-1;zeros(35,1)];
    case 5
        timecourse =  repmat([1;-1],36,1);
end
...
% saving config
%datadir = '/home/data/heiko/Temporal';
datadir = './data';
...
% if distance <= 1000 && f <= 4
%     size0 = [10,10];
% elseif distance >=2000 && f>=4
%     size0 = [3,3];
% else
%     error('Distance and spatial frequency mismatch!');
% end
size0 = [10,10];
if numel(size0)== 1
